...
#Range of cryostat:=======================================
#X range: [ -391.399 ,  463.392 ]
#Y range: [ -65.0454 ,  644.949 ]
#Z range: [ -193.73 ,  661.053 ]
#I will set the step length as 10cm for each axis---


verX = list(range(-385, 459, 10))
verY = list(range(-55, 639, 10))
verZ = list(range(-185, 659, 10))
...
def eval(pos, modpath, label):
    ...
    dim_pdr = 160 #num of opch---
    mtier = 0 #Not importan---

    #Import model!---
    print('Loading protodunehd_v6 160 opch net...')
...
#Execution CODE=========================================
vertex = get_data(3)
module_path = './output_8192b_10000e0-mod/'
